...
let result = deleteOne("Epicode", true);
console.log(result);
result = deleteOne("Epicode", false);
console.log(result);
...
isThisAnEmail("giuseppe.chia95@gmail.com");
...
console.log(deleteProp(obj, "accademy"));
...
let newestMovie = function () {
  let order = movies.sort((latestMovie) => {
    return latestMovie.Year;
  });
...
let countMovies = (moviesQuantity) => {
  return moviesQuantity.length;
};
